...
`circlecorR` draws **correlation wheel** plots with variables arranged
...
correlations also **removes them from the multiple-comparison family**,
which improves statistical power (see
...
- Gharibans AA, Calder S, Varghese C, Waite S, Schamberg G, Daker C, et
  ...
  Med.* 2022 Sep 21;14(663):eabq3544.
...
- Xu W, Wang T, Foong D, Schamberg G, Evennett N, Beban G, et al.
  Characterization of gastric dysfunction after fundoplication using
...
- Xu W, Gharibans AA, Calder S, Schamberg G, Walters A, Jang J, et al.
  ...
  diabetes using a novel body surface gastric mapping device. *Gastro
  Hep Adv.* 2023 Aug 18;2(8):1120–32.
